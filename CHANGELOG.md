...
- Agents/Subagents: add `cancel` action to `subagents` tool for cancelling running sub-agents. Supports cancellation by run ID, label, index, "last", or "all". Also cascades cancellation to child/descendant subagents. Thanks @Heldinhow.
