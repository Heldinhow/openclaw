...
export const pt_BR: TranslationMap = {
  ...
  subtitles: {
    ...
    subagents: "Monitorar subagentes ativos e suas tarefas.",
  ...
  subagents: {
    subtitle: "Monitorar subagentes ativos e suas tarefas.",
    task: "Tarefa",
    startedAt: "Iniciado",
    runtime: "Tempo de execução",
    spawnedBy: "Criado por",
    depth: "Profundidade",
    filterAll: "Todos",
    ...
    filterFailed: "Falhos",
    count: "subagentes",
    loading: "Carregando subagentes...",
    empty: "Nenhum subagente encontrado",
    emptyFiltered: "Nenhum subagente {status} encontrado",
    total: "Total",
    polling: "Intervalo de atualização: 5s",
  },
  languages: {
    en: "English",
