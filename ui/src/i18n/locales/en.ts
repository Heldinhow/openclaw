...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    subagents: "Monitor active subagents and their tasks.",
  ...
  subagents: {
    subtitle: "Monitor active subagents and their tasks.",
    task: "Task",
    startedAt: "Started",
    runtime: "Runtime",
    ...
    emptyFiltered: "No {status} subagents found",
    total: "Total",
    polling: "Polling interval: 5s",
  },
  languages: {
    en: "English",
